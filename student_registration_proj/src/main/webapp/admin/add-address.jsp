...
<div class="card col-md-5">
	...
	<div class="card-body ">
		<form action="/admin/addAddress" method="post">
			...
			<div class="mb-3">
				<label for="township" class="form-label text-primary">Township</label> <input
					type="text" class="form-control" id="township" name="township">
			</div>
			<div class="mb-3">
				<label for="street" class="form-label text-primary">Street</label> <input
