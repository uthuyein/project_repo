...
<div class="card col-md-5">
	...
	<div class="card-body ">
		<form action="/admin/schoolInfo" method="post">
			<div class="mb-3">
				<label for="rollNumber" class="form-label">Grade 12 Roll
			...
			<div class="row">
				<div class="col col-md-3">
					<div class="mb-3">
						<label for="eng" class="form-label">English</label> <input
							type="text" class="form-control" id="eng" name="eng">
					</div>
				</div>
				<div class="col col-md-3">
					<div class="mb-3">
						<label for="maths" class="form-label">Mathematics:</label> <input
							type="text" class="form-control" id="maths" name="maths">
					</div>
				</div>
				<div class="col col-md-3">
					<div class="mb-3">
						<label for="phys" class="form-label">Physics</label> <input
							type="text" class="form-control" id="phys" name="phys">
					</div>
				</div>
				<div class="col col-md-3">
					<div class="mb-3">
						<label for="chem" class="form-label">Chemistry</label> <input
			...
			<div class="mb-3">
				<label for="ttl" class="form-label">Total Marks</label> <input
