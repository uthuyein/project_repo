			...
			<c:choose>
				...
				<form action="${addStudent}" method="post"
					...
					<input type="text" class="form-control" id="stuId"
								name="stuId" value="${s.id() }" hidden>
					<div class="card-body ">

						<div id="studentId"
							class="card-header mb-3 primary-header-text-color">
							<i class="bi bi-person-fill "></i>&nbsp;Update Student Information
						</div>
						<div class="row">
							<div class="col mt-4">
								<div>
						...
						<div class="mb-3">
							<label for="religion" class="form-label primary-text-color">Nation
								...
								id="religion" name="religion" required="required" value="${s.religion() }">
						...
						<div class="mb-3">
							<label for="nrc" class="form-label primary-text-color">National
								...
								id="nrc" name="nrc" required="required" value="${s.nrc() }">
						...
						<div class="mb-3">
							<label for="pContact" class="form-label primary-text-color">Primary
								...
								name="pContact" required="required" value="${s.primaryContact() }">
						...
						<div class="mb-3">
							<label for="sContact" class="form-label primary-text-color">Secondary
								...
								name="sContact" required="required" value="${s.secondaryContact() }">
						...
						<div class="mb-3">
							<label for="rollNumber" class="form-label primary-text-color">Grade
								...
								id="rollNumber" name="rollNumber" required="required" value="${s.rollNum() }">
						...
						<div class="mb-3">
							<label for="fNrc" class="form-label primary-text-color">Father's
								...
								name="fNrc" required="required" value="${s.fNrc() }">
						...
						<div class="mb-3">
							<label for="mNrc" class="form-label primary-text-color">Mother's
								...
								name="mNrc" required="required" value="${s.mNrc() }">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control" id="street" name="street"
								required="required" value="${s.street() }">
