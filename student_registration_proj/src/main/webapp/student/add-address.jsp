	...
	<div class="card col-md-5">
		...
		<div class="card-body ">
			<form action="/student/addAddress" method="post">
				<div class="mb-3">
					<label for="fName" class="form-label text-primary">Father's
						Name</label> <input type="text" class="form-control" id="fName">
				</div>
				<div class="mb-3">
					<label for="mName" class="form-label text-primary">Mother's
						Name</label> <input type="text" class="form-control" id="mName">
				</div>
				<div class="mb-3">
					<label for="fNrc" class="form-label text-primary">Father's
						NRC</label> <input type="text" class="form-control" id="nrc">
				</div>
				<div class="mb-3">
					<label for="mNrc" class="form-label text-primary">Mother's
