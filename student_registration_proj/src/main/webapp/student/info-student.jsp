...
<div id="test" class=" ">
	<div class="row" data-bs-spy="scroll" data-bs-target="#navbar-example"
		...
		<nav id="navbar-example" class="navbar navbar-light bg-light px-3 sticky-sm-top">
			<ul class="nav nav-pills">
				<li class="nav-item"><a class="nav-link primary-text-color fs-sm" href="#studentId">Student</a></li>
				<li class="nav-item"><a class="nav-link primary-text-color" href="#universityId">University</a></li>
				<li class="nav-item"><a class="nav-link primary-text-color" href="#schoolId">School</a></li>
				<li class="nav-item"><a class="nav-link primary-text-color" href="#parentId">Parent</a></li>
				<li class="nav-item"><a class="nav-link primary-text-color" href="#addressId">Address</a></li>

			</ul>
		</nav>
		<div class="row justify-content-center  p-5 ">
			<div data-bs-spy="scroll" data-bs-target="#navbar-example"
				data-bs-offset="0" class="col col-md-6 scrollspy-example" tabindex="0">
				<div id="studentId"
				...
				<div class="card-body ">
					<form action="/admin/addUniInfo" method="post">
						...
						<button type="submit" class="btn primary-color w-25">Save
							University</button>
					</form>
				</div>
				<div id="schoolId"
			...
			<button type="submit" class="btn primary-color">Continue >></button>
				...
				<div class="card-body ">
					<form action="/admin/addAddress" method="post">
						...
						<button type="submit" class="btn primary-color">Save Address</button>
					</form>
				</div>
			</div>
		</div>
